        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="habit-name" className="block text-sm font-semibold text-slate-300 mb-2.5">Nome do Hábito</label>
                        <input
                            id="habit-name"
                            type="text"
                            value={name}
                    ...
                    {habitType === 'numeric' && (
                        <>
                            <div>
                                <label htmlFor="habit-unit" className="block text-sm font-semibold text-slate-300 mb-2.5">Unidade de Medida</label>
                                <select
                                    id="habit-unit"
                                    value={unit}
                            ...
                            <div>
                                <label htmlFor="habit-target" className="block text-sm font-semibold text-slate-300 mb-2.5">Meta Diária</label>
                                <input
                                    id="habit-target"
                                    type="number"
                                    step="0.1"
