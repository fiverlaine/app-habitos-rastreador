        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <label htmlFor="edit-habit-name" className="block text-sm font-medium text-slate-300 mb-2">Nome do Hábito</label>
                        <input
                            id="edit-habit-name"
                            type="text"
                            value={name}
                    ...
                    {habitType === 'numeric' && (
                        <>
                            <div className="mb-4">
                                <label htmlFor="edit-habit-unit" className="block text-sm font-medium text-slate-300 mb-2">Unidade de Medida</label>
                                <select
                                    id="edit-habit-unit"
                                    value={unit}
                            ...
                            <div className="mb-4">
                                <label htmlFor="edit-habit-target" className="block text-sm font-medium text-slate-300 mb-2">Meta Diária</label>
                                <input
                    ...
                    <div className="flex gap-3">
                        <button 
                            type="button"
                            onClick={onClose} 
                            className="flex-1 bg-slate-700 text-white font-bold py-3 px-4 rounded-md hover:bg-slate-600 transition-colors"
                        >
                            Cancelar
                        </button>
                        <button 
                            type="submit" 
                            className="flex-1 bg-indigo-600 text-white font-bold py-3 px-4 rounded-md hover:bg-indigo-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-indigo-500"
                        >
                            Salvar
                        </button>
                    </div>
